...
import { getCurrentUser, loginWithGoogle, loginWithMicrosoft, loginWithDiscord, logout, type User } from "./auth";
  ...
  if (user) {
    ...
    authContainer.innerHTML = `
      <div class="auth-buttons">
        ...
        <button id="login-microsoft" class="btn btn-microsoft">
        ...
        <button id="login-discord" class="btn btn-discord">
    ...
    document.getElementById("login-microsoft")?.addEventListener("click", loginWithMicrosoft);
